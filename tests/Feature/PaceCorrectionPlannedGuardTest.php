...
function validationReturningZipPlus4(): AddressValidationService
{
    ...
    // Every path now goes through the shared engine, which returns the carrier-corrected address.
    $mock->shouldReceive('validateForCarrier')->andReturnUsing(function (Address $a, $primary = null, $fallbacks = []) {
