...
class ImportBatch extends Model
{
    ...
    protected $fillable = [
        ...
        'origin_country_code',
        'find_best_service',
        'reverse_validate_future_date',
        'default_on_site_date',
        'default_ship_date',
        'bestway_plant_id',
        'bestway_carrier_account_id',
        'bestway_account_strict',
    ...
    protected function casts(): array
    {
        return [
            ...
            'reverse_validate_future_date' => 'boolean',
            'bestway_account_strict' => 'boolean',
            'check_both_sources' => 'boolean',
            'default_on_site_date' => 'date',
            'default_ship_date' => 'date',
            'started_at' => 'datetime',
